			...
			<div class="box-body" >
				<div class="user_profile_view">
						...
						<div class="single_details_profile mt-10">
							<div class="user_contact_details">
								<h4> <i class="fa fa-user-circle"></i> <?= html_escape($auth_info['name']) ;?> - <label title="Member Since" data-toggle="tooltip" data-placement="top"><i class="fa fa-clock-o"></i> <?= html_escape(full_date($auth_info['created_at']),restaurant()->id) ;?></label> </h4>
				...
				<div class="user_profile_details text-center mt-20">
					<div class="form-group">
						...
						<?php endif;?>
						<a href="#usernameModal" data-toggle="modal" class="btn btn-danger"><i class="fa fa-edit"></i> <?= lang('username'); ?></a>
					</div>
				</div>
				<?php endif;?>
			</div><!-- /.box-body -->
				...
				<?php if(!empty($restaurant)): ?>
					<div class="user_profile_view">
							...
							<div class="single_details_profile mt-10">
								<div class="user_contact_details">
									<div class=" profile_bottom_details">
										<h4> <i class="fa fa-user-circle"></i> <?= !empty($restaurant['name'])?html_escape($restaurant['name']):html_escape($restaurant['username']) ;?> - <label title="Member Since" data-toggle="tooltip" data-placement="top"><i class="fa fa-clock-o"></i> <?= html_escape(full_date($restaurant['created_at']),restaurant()->id) ;?></label> </h4>
			...
			<div class="modal-content">
				...
				<form action="<?= base_url("admin/auth/change_username"); ?>" method="POST">
					...
					<div class="modal-footer">
						...
						<button type="submit" class="btn btn-primary reg_btn" disabled>Save changes</button>
					</div>
				</form>
			</div>
		</div>
