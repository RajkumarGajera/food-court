...
<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 pr-5 pl-5">
  ...
  <!-- Add the bg color to the header using any of the bg-* classes -->
    <div class="widget-user-header profile profile_flex" style="background-color:#<?= trim($this->my_info['colors']) ;?>">
      <div class="widget-user-image profile-img-2">
        <img class="img-circle" src="<?= base_url(!empty(restaurant()->thumb)?restaurant()->thumb:'assets/admin/dist/img/user2-160x160.jpg') ;?>" alt="User Avatar">
      </div>
