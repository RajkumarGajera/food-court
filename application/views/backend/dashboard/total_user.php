			...
			<div class="box-body" >
				...
				<div class="table-responsive">
	                ...
	                <tr>
	                  ...
	                  <th><?= !empty(lang('view_profile'))?lang('view_profile'):"view profile";?></th>
	                ...
	                <?php $i=1; foreach ($all_user as $key => $row): ?>
		                <tr>
		                  ...
		                  <td>
		                  	<a href="javascript:;" title="Reset Password" data-toggle="tooltip" data-placement="top" class="btn btn-flat btn-warning btn-sm reset_password" data-id="<?= $row['id'];?>"> <i class="fa fa-lock"></i> </a>

		                  	<a href="<?= base_url('admin/auth/profile/'.md5($row['id'])); ?>"  data-toggle="tooltip" data-placement="top" title="Profile details" class="btn btn-flat btn-primary btn-sm" target="blank"> <i class="fa fa-eye"></i> </a>

							<?php if($this->session->userdata('user_role')==1): ?>
			                  	<a href="<?= base_url('admin/dashboard/delete_user/'.$row['id']) ?>" data-msg=" <?= lang('delete_user_msg'); ?>" class="btn btn-flat btn-danger btn-sm action_btn" data-toggle="tooltip" data-placement="top" title="Delete user" ><i class="fa fa-trash-o"></i></a>
		                  	<?php endif; ?>
		                  </td>
		                </tr>
	            	<?php $i++; endforeach ?>
