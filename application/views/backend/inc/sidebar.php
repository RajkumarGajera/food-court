  ...
  <?php if($this->auth['is_verify']==1): ?>
      ...
      <?php endif;?>
        <?php if(is_access('setting-control')==1): ?>
             ...
             <?php if(is_feature(auth('id'),'whatsapp')==1): ?>
                <li class="<?= isset($page_title) && $page_title =="Whatsapp Config"?"active":""; ?>">
                  <a href="<?= base_url('admin/auth/whatsapp_config') ?>">
                    <i class="fa fa-whatsapp fz-20"></i> <span><?= !empty(lang('whatsapp_config'))?lang('whatsapp_config'):"whatsapp config";?></span> <span class="ab-position custom_badge danger-light-active"><?= lang('new') ;?></span>
                  </a>
                </li>
               <?php endif; ?>
           <?php endif; ?>
          ...
          <li class="<?= isset($page_title) && $page_title =="Coupon List"?"active":""; ?> hidden">
            <a href="<?= base_url('admin/coupon/') ?>">
              <i class="fa fa-toggle-on"></i> <span><?= lang('coupon_list');?></span>
            </a>
          </li>
