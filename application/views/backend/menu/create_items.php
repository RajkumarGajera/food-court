		...
		<div class="col-md-5">
			<div class="box box-primary">
				<div class="box-header with-border dflex">
					...
					<?php if(!isset($_GET['action'])): ?>
						<a href="#addExtraModal" data-toggle="modal" class="addnewBtn btn btn-secondary btn-flat"><i class="fa fa-plus"></i> &nbsp;<?= !empty(lang('add_extras'))?lang('add_extras'):"Add Extras";?></a>	
					<?php endif;?>
