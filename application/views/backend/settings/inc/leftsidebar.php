		...
		<div class="card-body">
			<div class="leftSidebar">
				<ul class="flex-column">
					...
					<li><a href="<?= base_url('admin/settings/landing_page'); ?>" class="<?= isset($page_title) && $page_title == "Landing Page Settings"?"active":"" ;?>" ><i class="icofont-laptop-alt"></i> <?= !empty(lang('custom_landing_page'))?lang('custom_landing_page'):"Custom Landing Page";?> <span class="ab-position custom_badge danger-light-active"><?= lang('new') ;?></span></a></li>

					<li><a href="<?= base_url('admin/settings/extras'); ?>" class="<?= isset($page_title) && $page_title == "Extras"?"active":"" ;?>" ><i class="icofont-ui-next"></i> <?= !empty(lang('extras'))?lang('extras'):"Extras";?> <span class="ab-position custom_badge danger-light-active"><?= lang('new') ;?></span></a></li>
					
					<?php if(check()==1): ?>
						<li><a href="<?= base_url('admin/settings/pwa_config') ?>" class="<?= isset($page_title) && $page_title == "PWA Config"?"active":"" ;?> <?= is_package;?>"><i class="icofont-share-alt"></i> <?= lang('pwa_config');?></a> <span class="ab-position custom_badge danger-light-active"><?= lang('new') ;?></span></li>
					<?php endif;?>
				</ul>
			</div>
		</div>
