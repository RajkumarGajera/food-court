							...
							<div class="form_content">
								...
								<form action="<?= base_url('login/user_login') ?>" class="" method="post" id="user_login_form" autocomplete="off">
									...
									<div class="login_form" >
										...
										<div class="form-group">
											<label><i class="fa fa-key"></i> <?= !empty(lang('password'))?lang('password'):"password";?> <a href="<?= base_url('login/forgot');?>" class="ml-7"><?= !empty(lang('forgot'))?lang('forgot'):"Forgot?";?></a></label>
