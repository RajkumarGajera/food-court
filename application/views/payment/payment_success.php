                  ...
                  <div class="successOrder">
                    <div class="confirmMsgArea payInCash">
                     <i class="icofont-check-circled fa-3x successIcon success-light mb-7"></i>
                      ...
                      <?php if(shop($shop_id)->is_whatsapp ==1): ?>
                      <div class="whatsapp_share_data">
                          <?php $this->load->view('layouts/ajax_whatsapp_share', $info['load_data']); ?>
                      </div>
                    <?php endif; ?>


                      <div class="okbtn_area">
                        <a href="<?= base_url($slug) ;?>" class="btn btn-success redirect_btn"><i class="icofont-hand-drag1"></i> <?= lang('ok'); ?></a>
                      </div>
                    </div>
                  </div>
            </div>
