...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 16, 2022 at 10:46 AM
...
INSERT INTO `language_data` (`id`, `keyword`, `type`, `details`, `english`, `ar`, `es`, `ru`, `cn`, `fr`, `pt`, `hindi`, `bn`) VALUES
(1, 'alert', 'admin', '', 'Alert!', 'تنبيه!', '¡Alerta!', 'Внимание!', '警报！', 'Alert!', 'Alerta!', 'अलर्ट!', 'আমার '),
(2, 'net_income', 'admin', '', 'Net income', 'صافي الدخل', 'Ingresos netos', 'Чистая прибыль', '净收入', 'Net income', 'Lucro líquido', 'शुद्ध आय', '.'),
(3, 'package_by_user', 'admin', '', 'Package by user', 'الحزمة من قبل المستخدم', 'Paquete por usuario', 'Пакет пользователем', '用户打包', 'Package by user', 'Pacote por usuário', 'उपयोगकर्ता द्वारा पैकेज', 'বাংলা '),
...
(876, 'pay_later', 'admin', 'Pay Later', 'Pay Later', 'ادفع لاحقًا', 'Paga después', 'Оплата позже', '稍后付款', 'Payer plus tard', 'Pagar depois', 'बाद में भुगतान करें', 'পরে পরিশোধ কৃত '),
(877, 'import', 'admin', 'Import', 'Import', 'استيراد', 'Importar', 'Импорт', '导入', 'Importer', 'Importar', 'आयात', NULL),
(878, 'required_alert', 'admin', 'Please fill up the % field', 'Please fill up the %s field', 'الرجاء ملء حقل٪ s', 'Por favor complete el campo %s', 'Пожалуйста, заполните поле %s', '请填写 %s 字段', 'Veuillez remplir le champ %s', 'Por favor, preencha o campo %s', 'कृपया %s फ़ील्ड भरें', NULL),
(879, 'pickup_area', 'admin', 'Pickup Area', 'Pickup Area', 'منطقة الالتقاء', 'Área de recogida', 'Зона самовывоза', '取货区', 'Zone de ramassage', 'Área de Retirada', 'पिकअप एरिया', NULL),
...
INSERT INTO `packages` (`id`, `package_name`, `slug`, `price`, `package_type`, `order_limit`, `item_limit`, `status`, `created_at`) VALUES
(1, 'Trial Basic', 'trial-basic', 0, 'fifteen', 3, 4, 1, '2021-09-07 11:27:33');
